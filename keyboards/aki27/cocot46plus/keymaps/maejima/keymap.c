...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|                                     |--------+--------+--------+--------+--------+--------|
      _______, _________________LATEX_L2__________________,                                       _________________LATEX_R2__________________,   TX_MU,
  //|--------+--------+--------+--------+--------+--------|                                     |--------+--------+--------+--------+--------+--------|
      _______, _________________LATEX_L3__________________,                                       _________________LATEX_R3__________________, _______,
  //|--------+--------+--------+--------+--------+--------|                                     |--------+--------+--------+--------+--------+--------|
                        _______, ______LATEX_LTHUMB_______, KC_MS_BTN4,             KC_MS_BTN5, ______LATEX_RTHUMB_______, _______,
                                                                 KC_PGUP, KC_MS_BTN3,  KC_PGDN, XXXXXXX, XXXXXXX, XXXXXXX
                                      //`--------------------------'                   `--------------------------'
    ),
#endif
