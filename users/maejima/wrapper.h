...
#define _________________LOWER_R3__________________     MODTAP_R3(XXXXXXX, XXXXXXX, XXXXXXX, S(KC_1), KC_BSLS)
...
#define _________________RAISE_L2__________________     _______, __________PARENTHESES_R___________
